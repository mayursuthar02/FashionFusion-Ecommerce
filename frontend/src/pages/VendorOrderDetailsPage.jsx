...
import { Avatar, Badge, Box, Divider, Flex, Grid, Image, Spinner, Table, TableContainer, Tbody, Td, Text, Tfoot, Th, Thead, Tr } from "@chakra-ui/react";
    ...
    <>
        ...
        {order && !loading && (
            <Box px={10} py={10} minH={'100vh'}>
                ...
                <Flex justify={'space-between'} gap={'40px'} mt={10} px={10}>
                    <Flex>
