...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <HomeProducts title={'men'} category={'men'}/>

      <HomeProducts title={'kurta set'} category={'women'} subCategory={'kurta set'}/>

      <HomeProducts title={'women'} category={'women'} subCategory={'top'}/>
